...
Gem::Specification.new do |s|
  ...
  s.summary     = 'A web-based, sql-backed front-end for the Ledger command-line accounting system'
  s.description = 'Allows arbitrary reporting on your ledger using easy-to-write SQL queries'
